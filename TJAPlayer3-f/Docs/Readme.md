...
この改造をしながら、C#を勉強しているため、相当な量の不具合が含まれていると思われます。  
...
趣味ですから、気分次第で実装をするので、不具合報告がなされても後回しにする可能性があります。すみません。
...
過疎鯖と化しているため、それでも良いという方のみお入りください。  
主に情報交換や「これ不具合？」のような質問を気軽に投稿していただくのためのサーバーであるため、不具合報告や実装要望などはGitHub Issuesにお願いいたします。  
情報を一箇所にまとめ一括管理をするためです。ご了承ください。
また、参加した際、#readmeをご一読ください。よろしくお願いいたします。  
